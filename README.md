...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vpv5so.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vpv5so.containers.anotherwebservice.com/
...
```
git clone git@github.com:purin475/container-vpv5so.git
cd container-vpv5so
```
...
```
docker attach container-vpv5so
```
